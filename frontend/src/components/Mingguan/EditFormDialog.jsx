// components/Mingguan/EditFormDialog.jsx
...
const EditFormDialog = ({ onClose, onEdit, initialData, loading }) => {
  const [formData, setFormData] = useState({
    id: initialData.id,
    tid: initialData.tid,
    kondisiCamera: initialData.kondisiCamera,
    kondisiNVR: initialData.kondisiNVR,
        ...
        <div className="bg-gradient-to-r from-[#43172F] to-[#5A1F40] p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">Edit Data Form</h2>
